...
class ApiUrl {
  ...
  static const String baseUrl = 'https://earnpro.live/';
  static const String configModel = "${baseUrl}admin/index.php/Mahajongapi/";
  static const String avaitorBaseUrl = "https://admin.earnpro.live/api/aviator/";
  static const String TRXBaseUrl = "https://admin.earnpro.live/api/trx/";
