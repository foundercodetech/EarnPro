...
import 'package:earnpro/testone.dart';
...
import 'package:earnpro/view/home/widgets/category_elements.dart';
import 'package:earnpro/view/home/widgets/category_widgets.dart';
import 'package:earnpro/view/home/widgets/slider_widget.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            Image.asset(Assets.imagesLogoredmeta,height: height*0.06),
            Center(child: textWidget(text: "Welcome to Earn pro",color: AppColors.goldencolor,fontWeight: FontWeight.bold,fontSize: width*0.036)),
          ],
        ),
        actions: [
          ...
          InkWell(
              onTap: (){
                ...
                // Navigator.push(context, MaterialPageRoute(builder: (context)=>const TestTwo()));
              },
  ...
  _launchURL2() async {
    var url = "https://earnpro.live/earnpro.apk";
    if (await canLaunch(url)) {
      await launch(url);
    } else {
      throw 'Could not launch $url';
