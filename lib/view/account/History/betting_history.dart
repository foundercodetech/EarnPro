...
import 'package:earnpro/view/home/cassino/Dragon_tiger/Apimodel/bethistory.dart';
...
import 'package:earnpro/view/account/History/aviator_bet_history.dart';
...
class _BetHistoryState extends State<BetHistory> with SingleTickerProviderStateMixin {
  ...
  List<BetIconModel> betIconList = [
    ...
    if (!kIsWeb) BetIconModel(title: 'Dragon Tiger', image: Assets.imagesCasinoIcon),
