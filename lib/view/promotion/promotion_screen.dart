...
import 'package:earnpro/model/Mlm_Plan_model.dart';
...
import 'package:earnpro/view/promotion/horizontal_scale.dart';
import 'package:earnpro/view/promotion/level_plan.dart';
                            ...
                            child: Column(
                              children: [
                                ...
                                AppBtn(
                                  ...
                                  fontWeight: FontWeight.w900,
                                  onTap: () async {
                                    String referralUrl = 'https://web.earnpro.live?id=${userData.referralCode}';
                                    Share.share('Its my referral Code : *${userData.referralCode}* link to join: $referralUrl  ,'
                                        ' Download Now :https://earnpro.live/earnpro.apk', subject: 'Join Now !!');
                                  },
                                ):
                                AppBtn(
